...
PYTHONNOUSERSITE=1 snakemake \
  ...
  --configfile /home/users/nus/e1124850/scratch/github/heritability_enrichment_ldsc/round3/vatconfig/config_vat.yaml
'''



with open('/Users/theeeight/github/heritability_enrichment_ldsc/round3/vatpbs/config_vat.pbs', 'w') as f:
    f.write(pbstemplete)
